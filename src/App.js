...
function App() {
  const seriesDB = {
    Suspense: [
      ...
      { name: "Teen Wolves", rating: "8.6/10" }
    ],
    Comedy: [
    ...
    Crime: [
      ...
      { name: "Elite", rating: "8.7/10" },
      { name: "The Sinner", rating: "8.6/10" },
      { name: "Money Heist", rating: "9.3/10" },
      { name: "Who Killed Sara", rating: "8.8/10" }
    ]
  };
  ...
  return (
    <div className="App">
      <h1>🎥T.V. Time</h1>
      <p>Some Mind Blowing Web Series with Awesome Twist</p>
      <div className="span">
        {genres.map((genre) => {
          return (
